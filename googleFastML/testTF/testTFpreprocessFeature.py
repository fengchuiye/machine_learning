...
#  processed_features["lati"] = abs(california_housing_dataframe["latitude"]-38)
...
#print(type(correlation_dataframe.corr()))
...
#correlation_dataframe["lati"] = abs(correlation_dataframe["latitude"]-38)
#print(correlation_dataframe["lati"])
